<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="POST" action="{{ isset($product) ? route('research-products.update', $product->id) : route('research-products.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($product))
            @method('PUT')
        @endif
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="flex justify-end">
                <a href="{{ route('research-products.index') }}" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-md mr-3 hover:bg-gray-300">
                    Cancel
                </a>
